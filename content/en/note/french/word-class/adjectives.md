...
- **B**eauty: *beau, joli*
- **A**ge: *jeune, vieux, ancien*
- **N**umber/order: *premier, dernier, prochain, deuxième*
- **G**oodness: *bon, mauvais*
- **S**ize: *grand, petit, gros, long, haut*
...
<u>Three adjectives</u> have an extra masculine singular form used before a vowel or silent *h*:
...
- Color adjectives derived from nouns: **marron**, **orange**, **crème**, **saumon**
  - <span style="opacity: 0.5">*contrast: rouge, vert, bleu, jaune etc. all agree normally*</span>
...
- **mauvais → pire** - bad → worse / worst
  - <span style="opacity: 0.5">*plus mauvais also exists but is less common*</span>

## References

- [Lawless French - Adjectives](https://www.lawlessfrench.com/grammar/adjectives/)
- [Lingolia - French Adjectives](https://francais.lingolia.com/en/grammar/adjectives)
