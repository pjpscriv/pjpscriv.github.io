import define1 from "./25270471425ecc0f@2153.js";
import define2 from "./5ccfcada87efd9fc@344.js";
...
function _swatch(GroupLegend,colors_list,titles_list){return(
...
function _colors_list(d3){return(
[ 
...
function _titles_list(){return(
[ "National", "Labour", "Greens", "ACT", "NZ First", "Te Pāti Māori" ]
)}

function _GroupLegend(d3,getBBox){return(
...
export default function define(runtime, observer) {
  ...
  main.import("party_colors", child1);
  const child2 = runtime.module(define2);
  main.import("getBBox", child2);
  return main;
}
