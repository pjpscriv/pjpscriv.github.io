import define1 from "./a92530c4a8c504e6@20.js";
import define2 from "./c05b7b08bc1bf956@45.js";
import define3 from "./a33468b95d0b15b0@817.js";
import define4 from "./3c870e3e02bdcc0b@480.js";

function _1(md){return(
md`# 2025 Aotearoa/New Zealand Electorates`
)}
...
function _chart(drawMap){return(
...
function _candidate_hexmap(drawMap){return(
drawMap("candidate", "zoomed")
)}

function _x(md){return(
...
md`The nation gave **${d3.format(".1%")(national_lean.normalised_lean)} of the vote to the right**, with:
...
function _party_chart(drawMap){return(
...
function _rel_party_chart(drawMap){return(
...
md`### References
- [2023 Version](https://observablehq.com/@pjpscriv/nz-electorate-hexmap)
- https://thespinoff.co.nz/politics/04-11-2023/a-better-visual-breakdown-of-the-2023-election-results`
)}

function _29(md){return(
md`### Data
| _Source notebook: https://observablehq.com/@pjpscriv/2026-nz-election-data_`
)}

function _general_elec_data(FileAttachment){return(
FileAttachment("general_elects_simplified@6.json").json()
)}

function _māori_elec_data(FileAttachment){return(
FileAttachment("māori_elects_simplified@5.json").json()
)}

function _ui_extras_data(FileAttachment){return(
FileAttachment("zoomed_extras@2.json").json()
)}
...
function _drawMap(width,d3,getTooltip,drawExtras,ui_extras_data,drawElectorates,general_elec_data,māori_elec_data,flubber){return(
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["māori_elects_simplified@5.json", {url: new URL("./files/c16d79c62611b2b728b296e8c0540ae423120e07cd5cfdb88fca928df4837b15f000ecbd27641f18985c55751e583078e1a700320786f2de19c30f244cf88312.json", import.meta.url), mimeType: "application/json", toString}],
    ["zoomed_extras@2.json", {url: new URL("./files/01bab32cb488fe35f203bfb21feba804e1947a9bd04a1142b26624ad271256f178b217a322d737d68598415e62960b4a6dcfe45266609a5827ecac170a18e087.json", import.meta.url), mimeType: "application/json", toString}],
    ["general_elects_simplified@6.json", {url: new URL("./files/cbf8fb2a7f20bda2406af89598c95873844e86a43606dacacce4197f9bac0f7acb5adfcaa63caf1dc15eb33ff31020736b4a2a0376c2d8b6f75b39618fccfda8.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  ...
  main.import("vote_data", child1);
  main.import("national_lean", child1);
